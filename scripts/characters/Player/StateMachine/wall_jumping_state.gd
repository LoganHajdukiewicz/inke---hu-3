...
var wall_jump_velocity: float = 10
var wall_jump_horizontal_force: float = 10.0
var wall_direction: Vector3 = Vector3.ZERO
var wall_jump_timer: float = 0.0
var wall_jump_duration: float = 0.3  # Time to maintain wall jump momentum
var wall_jump_buffer_time: float = 0.1  # Small buffer to prevent immediate re-wall-jumping
...
func physics_update(delta: float):
	...
	if Input.is_action_just_pressed("jump") and wall_jump_timer > wall_jump_buffer_time and player.can_perform_wall_jump():
